...
install-package erlang-eldap 1:27
install-package erlang-ftp 1:27
install-package erlang-inets 1:27
install-package erlang-os-mon 1:27
install-package erlang-parsetools 1:27
install-package erlang-tools 1:27
install-package erlang-xmerl 1:27

## Install rabbitmq-server and its dependencies
install-package rabbitmq-server 4.1
