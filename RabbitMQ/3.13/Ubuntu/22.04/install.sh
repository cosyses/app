...
install-package erlang-base 1:26.2.5
install-package erlang-asn1 1:26.2.5
install-package erlang-mnesia 1:26.2.5
install-package erlang-crypto 1:26.2.5
install-package erlang-public-key 1:26.2.5
install-package erlang-runtime-tools 1:26.2.5
install-package erlang-ssl 1:26.2.5
install-package erlang-eldap 1:26.2.5
install-package erlang-ftp 1:26.2.5
install-package erlang-tftp 1:26.2.5
install-package erlang-inets 1:26.2.5
install-package erlang-snmp 1:26.2.5
install-package erlang-os-mon 1:26.2.5
install-package erlang-parsetools 1:26.2.5
install-package erlang-tools 1:26.2.5
install-package erlang-xmerl 1:26.2.5
install-package erlang-syntax-tools 1:26.2.5

## Install rabbitmq-server and its dependencies
install-package rabbitmq-server 3.13
