...
OPTIONS:
  ...
  --removeFile        Remove import file after import (yes/no), default: no
...
mariadb "-h${databaseHost}" "-P${databasePort}" "-u${databaseUser}" --binary-mode --default-character-set=utf8 --max_allowed_packet=2G --init-command="SET SESSION FOREIGN_KEY_CHECKS=0;" "${databaseName}" < "${tempDir}/import.sql"
