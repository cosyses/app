...
cd /usr/share/elasticsearch || exit 1

if [[ $(bin/elasticsearch-plugin list | grep "analysis-phonetic" | wc -l) -eq 0 ]]; then
...
if [[ $(bin/elasticsearch-plugin list | grep "analysis-icu" | wc -l) -eq 0 ]]; then
