...
echo "Creating configuration at: /etc/php/8.1/mods-available/mcrypt.ini"
...
cd /tmp
wget -nv https://pecl.php.net/get/solr-2.6.0.tgz
tar zxvf solr-2.6.0.tgz
cd solr-2.6.0
phpize
autoconf
./configure
...
echo "Creating configuration at: /etc/php/8.1/mods-available/solr.ini"
echo "extension=solr.so" > /etc/php/8.1/mods-available/solr.ini
