...
replace-file-content /etc/php/7.4/apache2/php.ini "max_execution_time = 3600" "max_execution_time = 30"
replace-file-content /etc/php/7.4/apache2/php.ini "max_input_time = 3600" "max_input_time = 60"
replace-file-content /etc/php/7.4/apache2/php.ini "max_input_vars = 100000" "; max_input_vars = 1000"
replace-file-content /etc/php/7.4/apache2/php.ini "memory_limit = 4096M" "memory_limit = 128M"
add-file-content-after /etc/php/7.4/apache2/php.ini "error_log = /var/log/php/apache.log" "error_log = syslog" 1
