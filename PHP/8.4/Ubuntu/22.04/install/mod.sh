...
install-package libapache2-mod-php8.4
install-package libcurl4-openssl-dev

replace-file-content /etc/php/8.4/apache2/php.ini "max_execution_time = 3600" "max_execution_time = 30"
replace-file-content /etc/php/8.4/apache2/php.ini "max_input_time = 3600" "max_input_time = 60"
replace-file-content /etc/php/8.4/apache2/php.ini "max_input_vars = 100000" "; max_input_vars = 1000"
