...
add-gpg-repository "varnish-cache-7.4.list" "https://packagecloud.io/varnishcache/varnish74/ubuntu/" "jammy" "main" "https://packagecloud.io/varnishcache/varnish74/gpgkey" "y"
install-package varnish 7.4
