...
add-gpg-repository "varnish-cache-6.5.list" "https://packagecloud.io/varnishcache/varnish65/ubuntu/" "focal" "main" "https://packagecloud.io/varnishcache/varnish65/gpgkey" "y"
install-package varnish 6.5
