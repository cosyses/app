...
add-gpg-repository "varnish-cache-7.6.list" "https://packagecloud.io/varnishcache/varnish76/ubuntu/" "jammy" "main" "https://packagecloud.io/varnishcache/varnish76/gpgkey" "y"
install-package varnish 7.6
