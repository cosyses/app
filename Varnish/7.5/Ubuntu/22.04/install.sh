...
add-gpg-repository "varnish-cache-7.5.list" "https://packagecloud.io/varnishcache/varnish75/ubuntu/" "jammy" "main" "https://packagecloud.io/varnishcache/varnish75/gpgkey" "y"
install-package varnish 7.5
