...
add-gpg-repository "varnish-cache-7.1.list" "https://packagecloud.io/varnishcache/varnish71/ubuntu/" "focal" "main" "https://packagecloud.io/varnishcache/varnish71/gpgkey" "y"
install-package varnish 7.1
