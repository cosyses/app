...
add-gpg-repository "varnish-cache-7.0.list" "https://packagecloud.io/varnishcache/varnish70/ubuntu/" "focal" "main" "https://packagecloud.io/varnishcache/varnish70/gpgkey" "y"
install-package varnish 7.0
