...
add-gpg-repository "varnish-cache-8.0.list" "https://packagecloud.io/varnishcache/varnish80/ubuntu/" "jammy" "main" "https://packagecloud.io/varnishcache/varnish80/gpgkey" "y"
install-package varnish 8.0
