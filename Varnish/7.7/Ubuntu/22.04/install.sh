...
add-gpg-repository "varnish-cache-7.7.list" "https://packagecloud.io/varnishcache/varnish77/ubuntu/" "jammy" "main" "https://packagecloud.io/varnishcache/varnish77/gpgkey" "y"
install-package varnish 7.7
