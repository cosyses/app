...
add-gpg-repository "nginx.list" "https://nginx.org/packages/ubuntu/" "jammy" "nginx" "https://nginx.org/keys/nginx_signing.key" "y"
install-package nginx 1.28
...
add-file-content-after /etc/nginx/nginx.conf "worker_rlimit_nofile 32768;" "pid        /run/nginx.pid;" 1
